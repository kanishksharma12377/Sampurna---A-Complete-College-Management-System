...
## 1. Vision
Provide a low-cost, modular, extensible ERP for public / semi-public colleges using commodity cloud services (GSheets exports, serverless functions) to unify Admissions, Fees, Hostel, Examinations, Library, and Reporting without expensive proprietary licensing.
...
| Identity & Roles | Map auth users to institution roles | users, roles, roleAssignments |
...
| Auth | Authentication (anonymous + email + SSO later) |
